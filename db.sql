/* 이 프로젝트의 코드를 돌리려면 아래 테이블과 데이터를 만드셔야 합니다. */
...
insert  into users(user_id,user_name) values ('user1','사용자1');
insert  into users(user_id,user_name) values ('user2','사용자2');
insert  into users(user_id,user_name) values ('user3','사용자3');
